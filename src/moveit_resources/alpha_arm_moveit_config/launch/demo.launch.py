...
def generate_launch_description():
    ...
    print("Using demo file Reached 1")
    ...
    moveit_config = (
        ...
        .robot_description(
            file_path="config/alpha.config.xacro",
            mappings={
        ...
        .trajectory_execution(file_path="config/alpha_controllers.yaml")
        .planning_pipelines(
    ...
    rviz_base = os.path.join(
        get_package_share_directory("moveit_resources_alpha_arm_moveit_config"), "launch"
    )
